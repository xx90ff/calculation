<?php /* Smarty version 2.6.25, created on 2021-04-06 08:33:55
         compiled from ffsm/dashi/dashi_xm_10.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8"/>
<title><?php echo $this->_tpl_vars['dsyy_row']['project']; ?>
，大师在线服务-<?php echo $this->_tpl_vars['zhanming']; ?>
</title>
...
<h1 class="public_h_con"><?php echo $this->_tpl_vars['dsyy_row']['project']; ?>
</h1>
<a class="public_h_home" href="/?ac=dashi"></a><a href="?ac=history" class="public_h_menu">我的测算</a></header>
<div class="public_banner">
	<img src="<?php echo $this->_tpl_vars['dsyy_row']['images']; ?>
" alt="<?php echo $this->_tpl_vars['dsyy_row']['project']; ?>
"/>
	<span><?php echo $this->_tpl_vars['dsyy_row']['title']; ?>
</span>
</div>
<p class="ptxt"><?php echo $this->_tpl_vars['dsyy_row']['centent']; ?>
</p>
<p class="pcombtn">
		...
		<div class="public_form_wrap" id="miaodian">
			<ul>
				...
				<div class="auto" id="project_sls">
					<div type="text" class="bg_no" id="dsyy_money"/><?php echo $this->_tpl_vars['dsyy_row']['money']; ?>
元</div>
				</div>
				</li>
				<li>
				...
				<input type="hidden" name="project_id" id="project_id" value="<?php echo $this->_tpl_vars['dsyy_row']['id']; ?>
">
