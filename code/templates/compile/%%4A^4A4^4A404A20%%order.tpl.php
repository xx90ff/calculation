<?php /* Smarty version 2.6.25, created on 2021-04-05 23:19:39
         compiled from ffsm/xingzuo/order.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <title>2021年星座运势分析_十二星座-<?php echo $this->_tpl_vars['zhanming']; ?>
</title>
    ...
    <section class="main-wrap flex-column">
        <div class="banner-wrap flex-column">
            <div class="xinzuo-wrap flex-column">
                ...
                <img class="xinzuo-name" src="/statics/ffsm/xingzuo/img/<?php echo $this->_tpl_vars['data']['data']['img']; ?>
.png">
            </div>
    ...
    <div class="float-wrap flex-center" style="display:none;">
        <div class="float-btn flex-center">
            <div class="ceshi-box flex-center J_payPopupShow">
                ...
                <span class="price-text flex-center">查看完整解析( <em>￥<?php echo $this->_tpl_vars['data']['money']; ?>
</em>)</span>
            </div>
        </div>
    </div>
