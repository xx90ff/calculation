<?php /* Smarty version 2.6.25, created on 2021-04-05 22:55:58
         compiled from ffsm/vip.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8"/>
<title>购买VIP会员-<?php echo $this->_tpl_vars['zhanming']; ?>
</title>
...
<div class="headerbg"></div>
    <span class="uhead">
        <a href="/?ac=member">
            <b class="relative">
                <img class="head" src="<?php if ($this->_tpl_vars['member']['headimgurl']): ?><?php echo $this->_tpl_vars['member']['headimgurl']; ?>
<?php else: ?>/statics/user/images/userlogo.png<?php endif; ?>">
            </b>
        </a>
    </span>
    
    <a href="/?ac=member" class="usnmae"><?php echo $this->_tpl_vars['username']; ?>
正在加入VIP会员</a><nav>
    </nav>
</div>
...
<nav class="guclearfix"><div class="hg">会员类型</div>
                ...
                <div class="ct">
                <b>终身VIP会员</b>
                <p class="ms">¥<?php echo $this->_tpl_vars['money_z']; ?>
元 / 有效期 永久使用</p>
                </div>
            ...
            <div class="service-list mr_35 " data-money="200" data-time="365" data-buygroupid="2">
                ...
                <div class="ct">
                <b>包年VIP会员</b>
                <p class="ms">¥<?php echo $this->_tpl_vars['money_y']; ?>
元 / 有效期 365天</p>
                </div>
            ...
            <div class="service-list mr_35 " data-money="200" data-time="365" data-buygroupid="2">
                ...
                <div class="ct">
                <b>包月VIP会员</b>
                <p class="ms">¥<?php echo $this->_tpl_vars['money_m']; ?>
元 / 有效期 30天</p>
                </div>
