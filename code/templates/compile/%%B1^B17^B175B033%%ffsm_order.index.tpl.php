<?php /* Smarty version 2.6.25, created on 2021-03-19 09:25:32
...
<?php elseif ($this->_tpl_vars['field'] == 'data.gender'): ?>
                                          <?php if ($this->_tpl_vars['v']['type'] == 4): ?>无<?php else: ?><?php if ($this->_tpl_vars['v']['data']['gender'] == 0): ?>女<?php else: ?>男<?php endif; ?><?php endif; ?>
...
/?ac=history&state=2&oids=<?php echo $this->_tpl_vars['v'][$this->_tpl_vars['field']]; ?>
