<?php /* Smarty version 2.6.25, created on 2021-03-19 14:16:48
         compiled from ffsm/sssx/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'ffsm/sssx/index.tpl', 226, false),)), $this); ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8"/>
...
<link href="/statics/ffsm/sssx/css/wap.css" rel="stylesheet" type="text/css"/>
<link href="/statics/ffsm/sssx/css/style.min.css" rel="stylesheet" type="text/css"/>
...
unset($_smarty_tpl_vars);
 ?>
<script src="/statics/ffsm/sssx/js/vue.min.js"></script>
<script src="/statics/ffsm/sssx/js/jquery.min.js"></script>
<script src="statics/ffsm/public/js/require/require.min.js"></script>
<script src="statics/ffsm/public/js/common.min.js"></script>
<link rel="stylesheet" href="/statics/ffsm/sssx/css/public.css">
<link rel="stylesheet" href="/statics/ffsm/sssx/layui/css/layui.css"> 
...
<body>
<script src="/statics/ffsm/sssx/layui/layui.js"></script>
<div id="order">
<div class="public_header">
<a class="public_h_con" href="/?ac=sssx">实时速学</a><a href="javascript:void(0)" class="public_h_menu"<?php if ($this->_tpl_vars['nologin']): ?>  onclick="layer.msg('请登陆后查看',{time: 20000,btn: ['去登陆','不了'],yes: function(index, layero){
location.href='?ac=userlogin&return_url=<?php echo $this->_tpl_vars['return_url']; ?>
';
}});"<?php else: ?>:class="show" @click="chooseCoupon"<?php endif; ?> ><img src="/statics/ffsm/sssx/img/wddd.png" /></a></div>
<?php if ($this->_tpl_vars['gundong']): ?><div class="alert-marquee" id="alertMarquee"><span><img src="/statics/ffsm/sssx/img/laba.png" /></span><p class="inner"><?php echo $this->_tpl_vars['gundong']; ?>
</p></div><?php endif; ?>
<?php if ($this->_tpl_vars['my_order_num'] > 1): ?><div :class="show?'shadowHide':'shadow'" @click="chooseCoupon"></div><div id="coupon" :class="show?'couponHide':'coupon'">
  <?php else: ?><div :class="show?'shadow':'shadowHide'" @click="chooseCoupon"></div>
    <div id="coupon" :class="show?'coupon':'couponHide'"><?php endif; ?>	
		<div class="choseType">
			<div class="chose">
...
<div class="public_banner"  id="submit2">
	<img src="/statics/ffsm/sssx/img/banner.jpg" alt="实时速学"/>
</div>

<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => './ffsm/sssx/ss_icon.tpl', 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>

<div class="public_bg_from">
	<form class="J_ajaxForm J_testFixedShow" id="submit1" action="?ac=sssx" name="login" method="post" onSubmit="return checkForm();">
		...
		<div class="form_bottom_txt">
			<span>已为<b>328997</b>人查看2021年实时速学</span>
		</div>
	</form>
...
<div class="public_bg_color">
	<div class="center_bg">
		...
		<div class="im_info">
			...
			<img src="/statics/ffsm/sssx/img/info_l_bg.png" alt="" class="bg5">
			</div>
			<div class="im_info_c">
...
<p>每个人都有先天的智力值，但在效率值高的时候，更易思维活跃、学习力持久。多利用“精气神”中的优势项，去抓住能量迸发的天才时间点！即时利用，用更短的时间、更轻松的投入，就能获得学霸级的学习效果！</p>
</br>
<p>更能知晓自身优势和短板，在正确的时间点，利用自己优势，带动运势的提升。</p>
			...
			<img src="/statics/ffsm/sssx/img/info_r_bg.png" alt="" class="bg5">	
			</div>
		</div>
...
<script type="text/javascript">
    var home = new Vue({
        ...
        data:{
            ...
            couPonData:[
			 <?php $_from = $this->_tpl_vars['my_order']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['k'] => $this->_tpl_vars['i']):
?>
    <?php if ($this->_tpl_vars['i']['oid'] && $this->_tpl_vars['i']['status'] == 1): ?>
	{"name":'<?php echo $this->_tpl_vars['i']['data']['username']; ?>
',"time":"<?php echo ((is_array($_tmp=$this->_tpl_vars['i']['createtime'])) ? $this->_run_mod_handler('date_format', true, $_tmp, '%m月%d') : smarty_modifier_date_format($_tmp, '%m月%d')); ?>
","useMessage":"<?php echo $this->_tpl_vars['i']['typename']; ?>
","date":"<?php echo $this->_tpl_vars['i']['data']['y']; ?>
-<?php echo $this->_tpl_vars['i']['data']['m']; ?>
-<?php echo $this->_tpl_vars['i']['data']['d']; ?>
 <?php echo $this->_tpl_vars['i']['data']['h']; ?>
时","url":"<?php echo $this->_tpl_vars['i']['url']; ?>
",'isUse':true},
     <?php endif; ?>
...
layer.open({
        ...
        ,content: '<div style="padding: 25px; line-height: 22px;font-size: 16px; background-color: #f78990; color: #fff; font-weight: 300;">亲！<br><br>活动：《免单测试》 现在起只要注册、邀请注册，支付时选择积分支付立马免单！<br><br>登陆并测算后，我们将为您保存订单结果，点击“我的测算”即可查看历史订单！没有账号的请先注册哦~<br></div><div class="layui-layer-btn layui-layer-btn-c"><a class="layui-layer-btn0 labtn2" href="?ac=userlogin&return_url=<?php echo $this->_tpl_vars['return_url']; ?>
">去登陆</a><a class="layui-layer-btn1 labtn1 labtn2" href="?ac=userreg&return_url=<?php echo $this->_tpl_vars['return_url']; ?>
">去注册</a><a class="layui-layer-btn2 labtn2" href="javascript:void(0)" onclick="layer.close()">再看看</a></div>'
...
$('.J_ajax_submit_btnsub').click(function(){
	...
	<?php if ($this->_tpl_vars['nologin']): ?>islogin();return false;<?php endif; ?>
...
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => './ffsm/sssx/footer_jg.tpl', 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
