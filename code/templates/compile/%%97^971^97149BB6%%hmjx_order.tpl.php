<?php /* Smarty version 2.6.25, created on 2021-04-06 07:20:06
         compiled from ffsm/hmjx_order.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <title>号码解析-号码测试-<?php echo $this->_tpl_vars['zhanming']; ?>
</title>
    <!--[if lt IE 9]>  
...
<a href="/?ac=history" class="zm_cs">我的测试</a>
    </header>
        ...
        <div class="bzjp_zf_top">
            <div class="bzjp_zf_flex J_testFixedShow">
                <div class="bzjp_zf_content">
                    <p>你的出生日期是 <span class="redColor">公历 <?php echo $this->_tpl_vars['data']['y']; ?>
年<?php echo $this->_tpl_vars['data']['m']; ?>
月<?php echo $this->_tpl_vars['data']['d']; ?>
日<?php if ($this->_tpl_vars['data']['h']): ?><?php echo $this->_tpl_vars['data']['h']; ?>
<?php else: ?>未知<?php endif; ?>时</span></p>
                    <p class="jx_num">测试号码：<span class="redColor"><?php echo $this->_tpl_vars['data']['word']; ?>
</span></p>
                    <p>您的八字与这个号码有特殊的风水磁场，相生相助，相生相克，影响着你一生的运势，请一定要看。</p>
                    <p class="TImemoney">只需<?php echo $this->_tpl_vars['money']; ?>
元</p>
...
&type=1" class="zf weixin"><img src="/statics/ffsm/hmjx/picture/wxzf.png" alt="微信支付"/>微信支付</a>
              <?php endif; ?>
              <?php if ($this->_tpl_vars['sys_pay_type'] == 0 || $this->_tpl_vars['sys_pay_type'] == 2 || $this->_tpl_vars['sys_pay_type'] == 3): ?>
              <a href="/?ct=pay&ac=go&oid=<?php echo $this->_tpl_vars['oid']; ?>
&type=2" class="zf alipay"><img src="/statics/ffsm/hmjx/picture/zfbzf.png" alt="支付宝支付"/>支付宝支付</a>
              <?php endif; ?>
...
&type=wxpay" class="zf weixin"><img src="/statics/ffsm/hmjx/picture/wxzf.png" alt="微信支付"/>微信支付</a>
            <a href="/?ct=pay&ac=pay_go&oid=<?php echo $this->_tpl_vars['oid']; ?>
&type=alipay" class="zf alipay"><img src="/statics/ffsm/hmjx/picture/zfbzf.png" alt="支付宝支付"/>支付宝支付</a>
              <?php endif; ?>
			<?php if ($this->_tpl_vars['jf_sys_on'] == 1): ?>
				<a class="zf m-extpay" target="_self" href="/?ac=extgo&oid=<?php echo $this->_tpl_vars['oid']; ?>
">积分支付</a>
            <?php endif; ?>
            <?php if ($this->_tpl_vars['vip_on'] == 1): ?>
				<a class="zf m-vippay" target="_self" href="/?ac=vip_pay&oid=<?php echo $this->_tpl_vars['oid']; ?>
">vip免支付</a>
			<?php endif; ?>
              </div>
        </div>
