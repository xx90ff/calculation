<?php /* Smarty version 2.6.25, created on 2021-03-19 14:19:42
         compiled from ffsm/ssys/rtcaiyun.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'ffsm/ssys/rtcaiyun.tpl', 81, false),)), $this); ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8"/>
...
<a class="public_h_home" href="/"></a><a href="javascript:void(0)" class="public_h_menu"<?php if ($this->_tpl_vars['nologin']): ?>  onclick="layui.use('layer', function(){layer.msg('请登陆后查看',{time: 20000,btn: ['去登陆','不了'],yes: function(index, layero){
location.href='?ac=userlogin&return_url=<?php echo $this->_tpl_vars['return_url']; ?>
';
}});});"<?php else: ?>:class="show" @click="chooseCoupon"<?php endif; ?> >我的订单</a></div>
...
<div class="layui-collapse">
  <div class="layui-colla-item">
	...
	<?php $_from = $this->_tpl_vars['celebrity']['collection']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['k'] => $this->_tpl_vars['v']):
?>
			<div class="layui-collapse">
				  <div class="layui-colla-item">
					<h2 class="layui-colla-title"><?php echo $this->_tpl_vars['v']['name']; ?>
</h2>
					<div class="layui-colla-content">
					
					<?php $_from = $this->_tpl_vars['celebrity']['note']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['kk'] => $this->_tpl_vars['vv']):
?>
						<?php if ($this->_tpl_vars['v']['id'] == $this->_tpl_vars['vv']['celebrity_id']): ?>
						<div class="layui-elem-quote layui-quote-nm"><a href="?ac=rtcaiyun_example&cbid=<?php echo $this->_tpl_vars['vv']['id']; ?>
" class="layui-btn-fluid"><?php echo $this->_tpl_vars['vv']['event']; ?>
 <?php echo ((is_array($_tmp=$this->_tpl_vars['vv']['history_time'])) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d %H:%M:%S') : smarty_modifier_date_format($_tmp, '%Y-%m-%d %H:%M:%S')); ?>
</a></div>
						<?php endif; ?>
...
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => './ffsm/ssys/footer_jg.tpl', 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
