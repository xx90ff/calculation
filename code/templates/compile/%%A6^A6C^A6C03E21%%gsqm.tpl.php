<?php /* Smarty version 2.6.25, created on 2021-03-21 10:50:56
         compiled from ffsm/gsqm.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8"/>
<title>公司在线起名系统_公司名称吉凶评测-<?php echo $this->_tpl_vars['zhanming']; ?>
公司测名系统</title>
<meta name="keywords" content="公司起名,公司取名,公司测名" />
<meta name="description" content="公司名称是一个公司面对市场的象征，公司有一个好的名称不但可以带来好运，更能让大众熟知，公司名称评测系统可以对你公司名称进行运势评测，让你轻松为公司取个好名字。" />
	...
	<form class="J_ajaxForm J_testFixedShow" id="submit1" action="?ac=gsqm" name="login" method="post" onSubmit="return checkForm();">
		<div class="public_form_wrap" id="miaodian">
			<ul>
				...
				<div class="auto">
					<input type="text" class="bg_no" id="name" name="name" placeholder="如：<?php echo $this->_tpl_vars['zhanming']; ?>
络（不需填有限公司）" value=""/>
				</div>
				</li>
				<li>
...
<div class="public_bg_color">
	<div class="know_img">
		<img src="statics/ffsm/gsqm/images/gsqm3.jpg" alt="测试后您将知道以下信息"/>
		<img src="statics/ffsm/gsqm/images/gsqm4.jpg" alt="测试后您将知道以下信息"/>
	</div>
</div>
...
<div class="ainuo_foot_nav cl" id="testFixedBtn" style="display: none;">
    <ul>
     ...
     <li><a href="#submit1"class="botpost"><em><i class="lijics_1"></i></em><p>立即测试</p></a></li>
