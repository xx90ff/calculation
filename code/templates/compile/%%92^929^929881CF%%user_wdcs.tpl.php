<?php /* Smarty version 2.6.25, created on 2021-04-05 22:57:41
         compiled from ffsm/user_wdcs.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'ffsm/user_wdcs.tpl', 74, false),)), $this); ?>
<!DOCTYPE html>
<html>
<head>
...
?> 
  ...
  <div class="public_ddxx">
      ...
      <div class="public_k">
      <span class="public_pyzt_ddxx2">下单时间：<?php echo ((is_array($_tmp=$this->_tpl_vars['i']['createtime'])) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d %H:%M:%S') : smarty_modifier_date_format($_tmp, '%Y-%m-%d %H:%M:%S')); ?>
</span>
    </div>
...
<a href="/?ac=member">首页</a> <a href="/?ac=user_wdcs&page=<?php echo $this->_tpl_vars['pagepre']; ?>
" >< 上一页</a> <a href="/?ac=user_wdcs&page=<?php echo $this->_tpl_vars['pagenext']; ?>
">下一页 ></a> <a href="/?ac=user_wdcs&page=<?php echo $this->_tpl_vars['endpage']; ?>
">末页</a></div>
