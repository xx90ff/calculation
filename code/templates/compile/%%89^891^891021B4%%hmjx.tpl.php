<?php /* Smarty version 2.6.25, created on 2021-04-06 07:19:29
         compiled from ffsm/hmjx.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <title>号码解析-手机号码吉凶预测-车牌号码吉凶测试-<?php echo $this->_tpl_vars['zhanming']; ?>
</title>
	<meta name="Description" content="手机号码测吉凶,手机号码吉凶,号码吉凶" />
	<meta name="Keywords" content="提供手机号码吉凶预测和车牌号码吉凶预测，手机号码车牌号码测吉凶，每个人都有适合自己的幸运数据和不适合自己的幸运数字，选择一个好的号码可以助运自己，为自己带来好运。" />
    <!--[if lt IE 9]>  
    ...
    <div class="cs_bgcolor J_testFixedShow" id="scrollT" >
        ...
        <div class="m_form_container">
            <form class="J_ajaxForm J_testFixedTop" id="submit1" action="/?ac=hmjx" name="login" method="POST">
                ...
                <div class="m_form_btnwrap"><div class="m_form_submit">立即测试</div></div>
            </form>
        </div>
    </div>
