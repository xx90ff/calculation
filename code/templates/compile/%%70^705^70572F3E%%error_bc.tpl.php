<?php /* Smarty version 2.6.25, created on 2021-04-05 22:37:07
         compiled from ffsm/error_bc.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8"/>
<title><?php echo $this->_tpl_vars['err_log']; ?>
</title>
...
<div class="public_orders_search">
	<div class="public_os_info">
		温馨提示：<?php echo $this->_tpl_vars['err_log']; ?>

	</div>
	<ul class="problem_feedback">
		<li><a class="after_sales_link" href="<?php echo $this->_tpl_vars['err_url']; ?>
" hidetxt="<?php echo $this->_tpl_vars['err_tip']; ?>
"><?php echo $this->_tpl_vars['err_tip']; ?>
</a></li>
