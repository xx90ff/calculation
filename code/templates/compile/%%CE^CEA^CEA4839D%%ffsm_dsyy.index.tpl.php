<?php /* Smarty version 2.6.25, created on 2021-03-19 09:24:10
         compiled from admin/ffsm_dsyy.index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'admin/ffsm_dsyy.index.tpl', 185, false),array('modifier', 'count', 'admin/ffsm_dsyy.index.tpl', 289, false),)), $this); ?>
...
<?php elseif ($this->_tpl_vars['field'] == 'data.gender'): ?>
                                          <?php if ($this->_tpl_vars['v']['type'] == 4): ?>无<?php else: ?><?php if ($this->_tpl_vars['v']['data']['gender'] == 0): ?>男<?php else: ?>女 <?php endif; ?><?php endif; ?>
