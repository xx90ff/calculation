<?php /* Smarty version 2.6.25, created on 2021-04-06 11:46:22
         compiled from ffsm/taluo/bieren_order_xuanpai.tpl */ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
...
","positive":"<?php if ($this->_tpl_vars['data']['data']['carinfo']['5']['zf'] == 0): ?>逆位<?php else: ?>正位<?php endif; ?>"}];
    ...
    $('.view_img').click(function(){
        ...
        window.location.href = "/?ac=taluobieren&oid=<?php echo $this->_tpl_vars['data']['oid']; ?>
&pay=1";
    });
    // 重新选牌
