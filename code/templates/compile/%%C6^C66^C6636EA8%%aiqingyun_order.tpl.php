<?php /* Smarty version 2.6.25, created on 2021-04-06 08:40:18
         compiled from ffsm/aiqingyun_order.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8"/>
<title>2021爱情流年_爱情运势_姓名测试爱情_姓名爱情测试-<?php echo $this->_tpl_vars['zhanming']; ?>
</title>
<meta name="keywords" content="爱情运势,桃花运,桃花运测试,姓名测试爱情,姓名爱情测试">
<meta name="description" content="2021爱情运势详批，2021会是你红鸾之年吗？专业姓名爱情测试，马上为你揭晓2021年的桃花爱情玄机。">
...
<div class="contents">
  <div class="wrap">
    <div class="top">
      <img src="/statics/ffsm/aiqingyun/img/logo.png" alt="logo">
...
<div class="main" id="main">
  ...
  <div class="people">已有
    <em>148672</em>人测试，
    <em>96.3%</em>以上的测试用户表示对自己的感情生活有很大的指导作用。</div>
  <div class="ziliaos-box">
    <div class="name-list">
      <ul class="clearfix">
        <li class="li-name">
          <span>你的姓名：</span>
          <em><?php echo $this->_tpl_vars['names']['username']; ?>
(<?php if ($this->_tpl_vars['names']['gender'] == 1): ?>男<?php else: ?>女<?php endif; ?>)</em></li>
        <li class="li-name">
          <span>出生日期：</span>
          <em><?php echo $this->_tpl_vars['names']['y']; ?>
...
<?php else: ?>未知<?php endif; ?>时</em></li>
		  <li class="li-name">
          <span>订单编号：</span>
          <em><?php echo $this->_tpl_vars['oid']; ?>
</li>
      </ul>
    </div>
  </div>
  <div class="cszhifu-box">
    <div class="fourth-tit J_testFixedShow">
      <span>测试项目：2021年爱情运势详批</span></div>
    <div class="jiagebox clearfix">
      <p class="plf">
        <span>结缘价：<?php echo $this->_tpl_vars['money']; ?>
元</span>
        <em>（原价：168元）</em></p>
      <p class="prg">
        <span>距优惠结束</span>
        <em id="countDown">00:53:51</em></p>
...
&type=2" target="_blank">
            <p class="plf">
              <span class="zf-zfb"></span>支付宝支付</p>
            <p class="prg">
              <span>立即支付</span></p>
          </a>
        </li>
          <?php endif; ?>
            <?php if ($this->_tpl_vars['sys_pay_type'] == 0 || $this->_tpl_vars['sys_pay_type'] == 4): ?>
               <li>
          <a href="/?ct=pay&ac=pay_go&oid=<?php echo $this->_tpl_vars['oid']; ?>
&type=wxpay" target="_blank">
            <p class="plf">
              <span class="zf-wx"></span>微信支付</p>
            <p class="prg">
              <span>立即支付</span></p>
...
&type=alipay" target="_blank">
		...
		<?php if ($this->_tpl_vars['jf_sys_on'] == 1): ?>
			  <li>
          <a href="/?ac=extgo&oid=<?php echo $this->_tpl_vars['oid']; ?>
" target="_blank">
            <p class="plf">
              <span class="zf-extpay"></span>积分支付</p>
            <p class="prg">
              <span>立即支付</span></p>
          </a>
        </li>
        ...
        <?php if ($this->_tpl_vars['vip_on'] == 1): ?>
            <li>
          <a href="/?ac=vip_pay&oid=<?php echo $this->_tpl_vars['oid']; ?>
" target="_blank">
            <p class="plf">
              <span class="zf-vippay"></span>vip免支付</p>
            <p class="prg">
              <span>立即支付</span></p>
          </a>
        </li><?php endif; ?>
...
.ydgz{padding-top: 1rem;width: 50%;margin: 0 auto;}
.ydgz img{width: 100%;}
.ydgz p{color: #00b98d;font-size: 1.25rem;text-align: center;}
</style>
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => './ffsm/fengge/pcwxgz.tpl', 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
  </div>
  <div class="zfdivtips">支付成功后，需要返回当前浏览器查看结果</div>
  <!--zf end-->
  <div class="box">
    <div class="sec-title">2021爱情综合运势</div>
    <div class="borbox J_payPopupShow">
      <div class="borline"></div>
      <div class="jieguo-txt">
        <p class="ptit">戒骄戒躁，静候佳音</p>
        <div class="divimg">
          <img src="/statics/ffsm/aiqingyun/img/mh1.png" alt="">
          <div class="div-unlock">
            <div class="jzbox">
              <div class="jzcell">
                <a href="javascript:void(0)">完整鉴定</a></div>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="box">
    <div class="sec-title">探秘你的恋爱机缘</div>
    <div class="borbox J_payPopupShow">
      <div class="borline"></div>
      <div class="jieguo-txt">
        <div class="divimg">
  ...
  <div class="box">
    <div class="sec-title">爱情运势走向</div>
    <div class="borbox J_payPopupShow">
      <div class="borline"></div>
      <div class="jieguo-txt">
        <div class="divimg">
  ...
  <div class="box">
    <div class="sec-title">爱情指数高低</div>
    <div class="borbox J_payPopupShow">
      <div class="borline"></div>
      <div class="jieguo-txt">
        <div class="jieguo-zhishu">
          <ul>
            <li>
              <span class="sptxt">桃花指数：</span>
              <span class="spwen">?????</span></li>
            <li>
              <span class="sptxt">脱单指数：</span>
              <span class="spwen">?????</span></li>
            <li>
              <span class="sptxt">闪婚指数：</span>
              <span class="spwen">?????</span></li>
            <li>
              <span class="sptxt">幸福指数：</span>
              <span class="spwen">?????</span></li>
          </ul>
        </div>
        <div class="divimg">
  ...
  <div class="box">
    <div class="sec-title">2021爱情月份运势强弱</div>
    <div class="borbox J_payPopupShow">
      <div class="borline"></div>
      <div class="jieguo-txt">
        <div class="divimg" style="padding-top:20px;">
          <img src="/statics/ffsm/aiqingyun/img/mh4.png" alt=""></div>
        <div class="divimg">
          <img src="/statics/ffsm/aiqingyun/img/mh1.png" alt="">
          <div class="div-unlock">
            <div class="jzbox">
  ...
  <div class="box">
    <div class="sec-title">爱情幸福宣言</div>
    <div class="borbox J_payPopupShow">
      <div class="borline"></div>
      <div class="jieguo-txt">
        <div class="divimg">
...
<style type="text/css">
.ainuo_foot_nav{display: block; padding: 2px 0; background:#eb4c48; position: fixed; bottom: 0; width: 100%; z-index: 99999;max-width: 640px;}
