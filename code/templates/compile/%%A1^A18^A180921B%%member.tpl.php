<?php /* Smarty version 2.6.25, created on 2021-04-05 22:55:23
         compiled from ffsm/member.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'ffsm/member.tpl', 167, false),)), $this); ?>
<!DOCTYPE html>
<html>
<head>
<title>会员中-个人推广分销中心-<?php echo $this->_tpl_vars['zhanming']; ?>
</title>
...
<input id="code-url" type="hidden" value="http://<?php echo $this->_tpl_vars['dqurl']; ?>
/?dl=<?php echo $this->_tpl_vars['member']['uid']; ?>
"/><br />
...
<tr>
  ...
  <td><textarea name="text" id="sl" readonly="readonly name="name" class="make_resume_input" id="name">http://<?php echo $this->_tpl_vars['dqurl']; ?>
/?dl=<?php echo $this->_tpl_vars['member']['uid']; ?>
</textarea></td>
</tr>
<tr>
...
<br>
<b>分销可以获取多少提成？</b><br>
<font color="#ff3300">一级分销提成： %<?php echo $this->_tpl_vars['oneclass']; ?>
</font><br>
<font color="#0099330">二级别分销提成：%<?php echo $this->_tpl_vars['twoclass']; ?>
</font><br>
<font color="#6600ff">三级别分销提成：%<?php echo $this->_tpl_vars['threeclass']; ?>
</font> <br>
