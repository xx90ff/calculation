<?php /* Smarty version 2.6.25, created on 2021-03-19 14:42:38
         compiled from ffsm/ssxo/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'ffsm/ssxo/index.tpl', 225, false),)), $this); ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8"/>
...
<link href="/statics/ffsm/ssxo/css/style.min.css" rel="stylesheet" type="text/css"/>
...
unset($_smarty_tpl_vars);
 ?>
<script src="/statics/ffsm/ssxo/js/vue.min.js"></script>
...
<link rel="stylesheet" href="/statics/ffsm/ssxo/css/public.css">
<link rel="stylesheet" href="/statics/ffsm/ssxo/layui/css/layui.css"> 
...
<body>
<script src="/statics/ffsm/ssxo/layui/layui.js"></script>
<div id="order">
<div class="public_header">
<a class="public_h_con" href="/?ac=ssxo">实时寻偶</a><a href="javascript:void(0)" class="public_h_menu"<?php if ($this->_tpl_vars['nologin']): ?>  onclick="layer.msg('请登陆后查看',{time: 20000,btn: ['去登陆','不了'],yes: function(index, layero){
location.href='?ac=userlogin&return_url=<?php echo $this->_tpl_vars['return_url']; ?>
';
}});"<?php else: ?>:class="show" @click="chooseCoupon"<?php endif; ?> ><img src="/statics/ffsm/ssxo/img/wddd.png" /></a></div>
<?php if ($this->_tpl_vars['gundong']): ?><div class="alert-marquee" id="alertMarquee"><span><img src="/statics/ffsm/ssxo/img/laba.png" /></span><p class="inner"><?php echo $this->_tpl_vars['gundong']; ?>
</p></div><?php endif; ?>
...
<div class="public_banner"  id="submit2">
	<img src="/statics/ffsm/ssxo/img/banner.jpg" alt="实时寻偶"/>
</div>

<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => './ffsm/ssxo/ss_icon.tpl', 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>

<div class="public_bg_from">
	<form class="J_ajaxForm J_testFixedShow" id="submit1" action="?ac=ssxo" name="login" method="post" onSubmit="return checkForm();">
		...
		<div class="form_bottom_txt">
			<span>已为<b>5408</b>人查看2021年实时寻偶</span>
		</div>
	</form>
		...
		<div class="im_info">
			...
			<div class="im_info_c">
				...
				<div class="im_info_c_c">
                  ...
                  <p>在桃花值高的时候，更易遇见互相喜欢的人，多利用“精气神”中的优势项，去吸引对方，得到对方的好感，从而帮助你快速脱单。</p></br>
...
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => './ffsm/ssxo/footer_jg.tpl', 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
