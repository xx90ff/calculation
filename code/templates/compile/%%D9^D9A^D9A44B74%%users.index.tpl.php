<?php /* Smarty version 2.6.25, created on 2021-03-19 09:23:15
         compiled from admin/users.index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('myblock', 'lurd_list', 'admin/users.index.tpl', 59, false),array('modifier', 'truncate', 'admin/users.index.tpl', 66, false),array('modifier', 'date_format', 'admin/users.index.tpl', 72, false),array('modifier', 'round', 'admin/users.index.tpl', 75, false),array('function', 'frame_union', 'admin/users.index.tpl', 79, false),array('function', 'lurd', 'admin/users.index.tpl', 81, false),)), $this); ?>
...
?>
			<tr>
				<td> 
				    <input type="checkbox" class="checkbox" name="uid[]" value="<?php echo $this->_tpl_vars['v']['uid']; ?>
" rel="child" />
				</td>
				...
				<td> <?php echo ((is_array($_tmp=$this->_tpl_vars['v']['user_name'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 8) : smarty_modifier_truncate($_tmp, 8)); ?>
 </td>
				<td> 
...
');">
			    ...
			    <td> <?php if ($this->_tpl_vars['v']['vip_type'] == 38): ?>包月VIP 到期时间：<?php echo ((is_array($_tmp=$this->_tpl_vars['v']['vip_time'])) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d') : smarty_modifier_date_format($_tmp, '%Y-%m-%d')); ?>
<?php elseif ($this->_tpl_vars['v']['vip_type'] == 39): ?>包年VIP 到期时间：<?php echo ((is_array($_tmp=$this->_tpl_vars['v']['vip_time'])) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d') : smarty_modifier_date_format($_tmp, '%Y-%m-%d')); ?>
<?php elseif ($this->_tpl_vars['v']['vip_type'] == 40): ?>终身VIP<?php else: ?>普通用户<?php endif; ?></td>
				<td> <?php echo $this->_tpl_vars['v']['integral']; ?>
</td>
                <td> <?php echo $this->_tpl_vars['v']['dl_tcbl']; ?>
%</td>
                <td> <?php echo ((is_array($_tmp=$this->_tpl_vars['v']['dl_syjf'])) ? $this->_run_mod_handler('round', true, $_tmp, 2) : round($_tmp, 2)); ?>
 </td>
                <td> <?php echo ((is_array($_tmp=$this->_tpl_vars['v']['dl_zjf'])) ? $this->_run_mod_handler('round', true, $_tmp, 2) : round($_tmp, 2)); ?>
 </td>
