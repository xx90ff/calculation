<?php /* Smarty version 2.6.25, created on 2021-04-06 14:26:06
         compiled from ffsm/ziwei.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8"/>
<title>在线紫微斗数排盘起局系统-紫微斗数测试-<?php echo $this->_tpl_vars['zhanming']; ?>
</title>
<meta name="keywords" content="紫微排盘,紫微斗数在线排盘,紫微斗数" />
<meta name="description" content="<?php echo $this->_tpl_vars['zhanming']; ?>
在线紫微斗数排盘系统,紫微排盘分析,紫微斗数排盘运势分析,紫微斗数在线排盘解读运势,在线紫微斗数排盘测试,紫微斗数在线起局系统。" />
...
<div class="introduction" id="submit2">
	紫微斗数是东方中国最著名的占星学，利用人类出生时夏历时间进行斗数星盘的排列，将满天星曜飞布人生十二宫，并据以解释人生命运起伏，紫微斗数经老师团队多年研究，准确率高达95%！
</div>
<form class="J_ajaxForm" action="/?ac=ziwei" method="post" onSubmit="return checkForm();" name="login">
...
<select name="d" id="d" class="select_new">
	...
	<div class="public_btn_s J_testFixedShow">
    	<input type="submit" class="public_btn J_ajax_submit_btn" value="开启命盘">
	</div>
</form>
<div class="public_box">
	...
	<div class="public_box_pic">
		<p>
			<img src="/statics/ffsm/ziwei/1/images/img01.jpg"/>
		</p>
		<p>
			<img src="/statics/ffsm/ziwei/1/images/img02.jpg"/>
		</p>
	</div>
	<p class="publci_bg_top">
	</p>
	...
	<div class="public_box_pic">
		<p>
			<img src="/statics/ffsm/ziwei/1/images/img03.jpg"/>
		</p>
	</div>
	<div class="pb_txt">
	...
	<p class="public_box_pic">
		<img src="/statics/ffsm/ziwei/1/images/img04.jpg"/>
	</p>
	<p class="publci_bg_top">
	</p>
	<div class="destiny">
	...
	<div class="public_box_pic">
		<p>
			<img src="/statics/ffsm/ziwei/1/images/img05.jpg"/>
		</p>
	</div>
	...
	<div class="user_feedback">
		<div class="uf_ul_wrap" id="feedbackScroll">
			<ul class="uf_ul">
				...
				<p>
					我的性格和测试中说的一摸一样，自己在事业上老师犹豫不决，还好有老师的建议。谢谢老师！
				</p>
				</li>
...
<div class="protocol_pop_box" id="protocolPopBox">
	<div class="ppb_content">
		...
		<div class="ppb_text">
			...
			<p>
				此外，您已知悉并同意：<strong>在现行法律法规允许的范围内，汇丰科技可能会将您非隐私的个人信息用于市场营销，使用方式包括但不限于：在网页或者app平台中向您展示或提供广告和促销资料，向您通告或推荐服务或产品信息，使用，短信等方式推送其他此类根据您使用汇丰科技服务或产品的情况所认为您可能会感兴趣的信息。</strong>
			</p>
			<p>
			...
			<p>
				如果您还有其他问题和建议，可以通过52623867@qq.com或者电话000-0000000联系我们。
			</p>
			<p>
				汇丰科技保留对本协议的最终解释权。
			</p>
