<?php /* Smarty version 2.6.25, created on 2021-03-21 10:46:42
         compiled from ffsm/hehun.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8"/>
<title>在线生辰八字合婚_八字看命中注定的姻缘_八字合婚-<?php echo $this->_tpl_vars['zhanming']; ?>
</title>
<meta name="Keywords" content="八字合婚,八字配对,合八字,姻缘测试,婚姻配对,八字婚配测试" />
<meta name="Description" content="生辰八字合婚（八字配对）提供的八字合婚测试，八字姻缘测试，合八字,八字婚配服务是指根据周易八字命理，分析男女双方的生辰八字婚姻配对情况，预测两人的发展结果以及两人感情婚姻中可能出现的问题，并提出化解方法与建议，供男女双方参考。" />
...
<div class="public_tab_item J_testFixedShow">
	<form class="J_ajaxForm" action="/?ac=hehun" method="post" id="submit1"  name="login"  onSubmit="return checkForm();">
		<div class="public_form_wrap">
			<div class="sub_left left">
				<span><img src="/statics/ffsm/bazihehun/1/images/icon_man.png" alt="男方资料"/></span>男方
			</div>
			<ul>
				<li>
				<div class="left">
		...
		<div class="public_form_wrap">
			<div class="sub_left left">
				<span><img src="/statics/ffsm/bazihehun/1/images/icon_woman.png" alt="女方资料"/></span>女方
			</div>
			<ul>
				<li>
				<div class="left">
      ...
      <input type="hidden" name="h1"  class="auto input J-time1" id='j_dd'  value="">
		...
		<div class="public_btn_s">
        	<input type="button" class="btn-submit J_ajax_submit_btnsub" value="马上测试">
		</div>
	</form>
	...
	<div class="box_scroll">
		...
		<div class="bs_ui" id="con2_qhd_3">
			<ul>
				...
				<p>
					女儿和对象处了7年了，还没有打算结婚，做家长挺着急的，通过测试才知道她们适合晚婚，我这才放心。
				</p>
				</li>
				<li><span class="red">余先生 150****9257</span>
				<p>
					测试的太准了，我现在婚姻情况就是浑浑噩噩的，希望今年能有所改善。
				</p>
				</li>
				...
				<p>
					对婚姻和人生的发展迷茫，测试之后终于有了方向。
				</p>
				</li>
				<li><span class="red">何女士 138****8154</span>
				<p>
					当初就觉得女儿和他不合适，唉，后悔没有早点来测试。
				</p>
				</li>
				<li><span class="red">洪女士 180****3483</span>
				<p>
					准备和男朋友结婚，特地来测试一次，希望能如结果所说，婚后生活幸福。
				</p>
				</li>
...
<div class="ainuo_foot_nav cl" id="testFixedBtn" style="display: none;">
    <ul>
     ...
     <li><a href="#submit2"class="botpost"><em><i class="lijics_1"></i></em><p>立即合婚</p></a></li>
...
依据本协议的规定提供服务，本协议具有合同效力。您必须完全同意以下所有条款，才能保证享受到更好的<?php echo $this->_tpl_vars['zhanming']; ?>
服务。您使用服务的行为将视为对本协议的接受，并同意接受本协议各项条款的约束。
			</p>
			<p>
...
控股或关联、运营合作单位除外）公开、透露用户个人信息，但由于政府要求、法律政策需要等原因除外。</strong>
			</p>
			<p>
...
<script src="/statics/suanming-hehun.js"></script>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
