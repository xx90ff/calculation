<?php /* Smarty version 2.6.25, created on 2021-04-06 08:38:04
         compiled from ffsm/aiqingyun.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8"/>
...
<div class="contents">
  <div class="wrap">
    ...
    <div class="main">
      ...
      <div class="box">
        <div class="sec-title">爱情指数大揭秘</div>
        <div class="borbox inborbox">
          <p class="pimg">
      ...
      <div class="box">
        <div class="sec-title">爱情运势月份旺度表</div>
        <div class="borbox inborbox">
          <p class="pimg">
      ...
      <div class="box">
        <div class="sec-title">完美爱情专业批示</div>
        <div class="borbox inborbox">
          <p class="pimg">
            <img src="/statics/ffsm/aiqingyun/img/pishi.png" alt=""></p>
        </div>
      </div>
	 <div class="tupian">
	  <img src="/statics/ffsm/aiqingyun/zyys.jpg" alt="">
	 </div>
    </div>
</div>
