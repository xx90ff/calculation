<?php /* Smarty version 2.6.25, created on 2021-04-06 11:46:37
         compiled from ffsm/taluo/bieren_order.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'ffsm/taluo/bieren_order.tpl', 134, false),)), $this); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <title>他心里有别人吗？塔罗占卜-<?php echo $this->_tpl_vars['zhanming']; ?>
</title>
    <style>
        * {
            margin: 0;
...
" class="taluo_card">
                        <p class="taluo_name">
                            ...
                            <?php echo $this->_tpl_vars['data']['data']['carinfo']['0']['titles']; ?>
                            <span>
                                &nbsp;(<?php if ($this->_tpl_vars['data']['data']['carinfo']['0']['zf'] == 0): ?>逆位<?php else: ?>正位<?php endif; ?>)                            </span>
                        </p>
                        <p class="item_title">象征意义:</p>
                        <p class="taluo_desc"><?php echo ((is_array($_tmp=$this->_tpl_vars['data']['data']['carinfo']['0']['des'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 20, "...", true) : smarty_modifier_truncate($_tmp, 20, "...", true)); ?>
</p>
                        <p class="item_title">牌面理解:</p>
                        <p class="taluo_desc"><?php echo ((is_array($_tmp=$this->_tpl_vars['data']['data']['carinfo']['0']['content'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 40, "...", true) : smarty_modifier_truncate($_tmp, 40, "...", true)); ?>
</p>
                    </div>
                    <div class="blur-wrap">
...
" class="tarot_card">
                <p class="tarot_name">
                    ...
                    &nbsp;<?php echo $this->_tpl_vars['data']['data']['carinfo']['1']['titles']; ?>
                    <span>
...
" class="tarot_card">
                <p class="tarot_name">
                    ...
                    &nbsp;<?php echo $this->_tpl_vars['data']['data']['carinfo']['2']['titles']; ?>
                    <span>
...
" class="tarot_card">
                <p class="tarot_name">
                    ...
                    &nbsp;<?php echo $this->_tpl_vars['data']['data']['carinfo']['3']['titles']; ?>
                    <span>
...
" class="tarot_card">
                <p class="tarot_name">
                    ...
                    &nbsp;<?php echo $this->_tpl_vars['data']['data']['carinfo']['4']['titles']; ?>
                    <span>
...
" class="tarot_card">
                <p class="tarot_name">
                    <img src="/statics/ffsm/taluo/bieren/img/c5.png" class="taluo_cardidx">
                    &nbsp;<?php echo $this->_tpl_vars['data']['data']['carinfo']['5']['titles']; ?>
                    <span>
