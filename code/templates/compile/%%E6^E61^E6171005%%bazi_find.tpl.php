<?php /* Smarty version 2.6.25, created on 2021-04-06 17:09:34
         compiled from ffsm/bazi_find.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
	<meta charset="UTF-8"/>
	<title>八字精批测试结果-<?php echo $this->_tpl_vars['zhanming']; ?>
</title>
...
季。</p>
          <p><span>喜用神:</span>  <?php echo $this->_tpl_vars['return']['data']['xiyongshen']['data']['xishen']; ?>
</p>
        </div>
        <!--<div class="sol-right">-->
  ...
  <div class="content-box page3-content">
    ...
    <div class="content-warp1">
      <div class="warp1-text-box">
		...
		<p> <?php echo $this->_tpl_vars['return']['data']['xiyongshen']['shiye']; ?>
</p>
		<p>与三合贵人共事或者得到三合贵人的帮助有利于你的事业的发展，有利于你的三合生肖，你的生肖<?php echo $this->_tpl_vars['return']['data']['xiyongshen']['sanhe']['sanhe']['0']; ?>
三合生肖<?php echo $this->_tpl_vars['return']['data']['xiyongshen']['sanhe']['sanhe']['1']; ?>
和生肖<?php echo $this->_tpl_vars['return']['data']['xiyongshen']['sanhe']['sanhe']['2']; ?>
。</p>
		</div>
      </div>
      <div class="warp1-text-box">
        <h3>●流年财运:
          <span></span></h3>
        <div class="warp1-text">
		<p><?php if ($this->_tpl_vars['return']['data']['zonghe']['lncy']): ?><?php echo $this->_tpl_vars['return']['data']['zonghe']['lncy']; ?>
<?php else: ?>你今年的财运浮沉反复，故此不宜大量投资及赌博，以免焦头烂额!幸而正财收入尚算稳定，故此若能量入为出，经济便不会出现赤字问题。此外，必须慎防受骗破财。今年的财运低沉的月份，是农历正月、五月、六月、九月及十二月，必须尽量减少不必要开支。财运较佳的月份，是农历一月、八月及十一月。<?php endif; ?></p>
		</div>
      </div>
      <div class="warp1-text-box">
        <h3>●先天财运:
          <span></span></h3>
        <div class="warp1-text">
		<p><?php if ($this->_tpl_vars['return']['data']['zonghe']['xtcy']): ?><?php echo $this->_tpl_vars['return']['data']['zonghe']['xtcy']; ?>
<?php else: ?>本命财运，你的财运上从总体上来说是相当不错的。你拥有着让人艳羡的终生不用为钱烦恼的运气。然而由于做人积极且个性外向，是个天生的乐天派的马大哈性格，大都没有储蓄的习惯，手头充裕的时候，常不会做有效的运用，反而是挥霍无度。然而，他们打进了中年以后，却很有可能获得意外之财。如果在理财上如何趋利避害，关键便在于运用、开发好自己的大脑一般都会是大富大贵之人。<?php endif; ?></p>
		</div>
      </div>
      <div class="warp1-text-box">
        <h3>●注意事项:
          <span></span></h3>
        <div class="warp1-text">
		<p><?php if ($this->_tpl_vars['return']['data']['zonghe']['zhuyi']): ?><?php echo $this->_tpl_vars['return']['data']['zonghe']['zhuyi']; ?>
<?php else: ?>建议主动帮长辈定期做身体检查，一则避免亲人有突发的重大疾病而意外破财，二则主动消费对财运有帮助。易有意料之外的小财运，但难以保存，最好购置保值物品或小投资的方式留财。外地走动财运更好，特别是外出业务合作、表演。<?php endif; ?></p>
		</div>
      </div>
      <div class="warp1-text-box">
        <h3>●性格分析:
          <span></span></h3>
        <div class="warp1-text">
		<p>您出生于农历<?php echo $this->_tpl_vars['return']['user']['lDate']; ?>
，五行生肖为:<?php echo $this->_tpl_vars['return']['user']['sx']; ?>
      ...
      <div class="warp1-text-box">
        <h3>●性格优缺点:
          <span></span></h3>
        <div class="warp1-text">
		  <p><font color="#ff4632">优点</font>:<?php if ($this->_tpl_vars['return']['data']['zonghe']['yx']): ?><?php echo $this->_tpl_vars['return']['data']['zonghe']['yx']; ?>
<?php else: ?>才智高且具优秀的头脑，行动活泼好动且伶俐。好竞争，手腕敏捷有侠义心情，反应快，能见机行事。社交手腕高明善解人意，很快与人打成一片，但不喜欢被人控制，喜爱追求新鲜事务。聪明、机智、创新有才华，能言善道，有极强的自我表现欲。非常适合演艺和推销工作猴年生的男性精力充沛身体健壮，常表现达观机智勇敢，对环境变化有很强的适应能力生性顽强不服输，拥有多项才能而能居主导地位。求知欲很强，记忆力超人，头脑灵活很有创造力。善于把握机会扩大发展，造成时势，成为大企业家。<?php endif; ?></p>
          <p><font color="#ff4632">缺点</font>:<?php if ($this->_tpl_vars['return']['data']['zonghe']['qd']): ?><?php echo $this->_tpl_vars['return']['data']['zonghe']['qd']; ?>
<?php else: ?>平常爱说大话，有时有反对人之意见虚语或伪诈行为。忽略必需遵守社会全体规范，有点不脚踏实地。生性爱玩缺乏耐心毅力，眼光看得不远，犯有今朝有酒今朝醉的毛病。依赖心很重，好夸张和爱慕虚荣且喜新厌旧，不管做任何事都不会持续太久。狡滑伪善，无耐心不忠实狂妄自大，过份乐观，自负心强喜投机。为了达成目的喜爱说谎骗人，尽管才智出众八面玲珑，却不能以德服人，是典型的机会主义者。猴年生人无论说话做事一定要诚实踏实，否则会一塌糊涂。有自以为是急就章的毛病，所以常导致错误失败。<?php endif; ?></p>
          </div>
      </div>
      <div class="warp1-text-box">
        <h3>●爱情分析:
