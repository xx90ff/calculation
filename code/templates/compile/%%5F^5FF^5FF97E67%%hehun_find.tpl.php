<?php /* Smarty version 2.6.25, created on 2021-04-06 17:36:39
         compiled from ffsm/hehun_find.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8"/>
<title><?php echo $this->_tpl_vars['data']['name']; ?>
和<?php echo $this->_tpl_vars['data']['name_a']; ?>
合婚测试结果-<?php echo $this->_tpl_vars['zhanming']; ?>
</title>
<meta name="keywords" content="八字合婚,周易八字配对,在线八字合婚,八字合婚免费测试" />
<meta name="description" content="<?php echo $this->_tpl_vars['zhanming']; ?>
提供婚姻测试八字合婚服务，解开婚姻与八字的姻缘关系，普渡每一个善信的有缘人，我们衷心祝愿您拥有幸福的婚姻生活。" />
...
<div class="pay_item">
	<div class="words">
		<span><?php echo $this->_tpl_vars['data']['name']; ?>
与<?php echo $this->_tpl_vars['data']['name_a']; ?>
的合婚结果</span>
	</div>
    <div class="public_bzhh_title J_payPopupShow">
		<span class="left"></span><span class="right"></span><span class="center">第一：<?php echo $this->_tpl_vars['data']['name']; ?>
先生的命格</span><i></i>
	</div>
	<div class="public_lock_content">
		<div class="list1 left">
			<p>生肖：<b><?php echo $this->_tpl_vars['data']['shengxiao1']; ?>
</b> 命宫：<b>为<?php echo $this->_tpl_vars['data']['m_n']; ?>
</b></p>
 ...
 | <?php echo $this->_tpl_vars['data']['shishen2']; ?>
            ...
            <p>您属于：<?php echo $this->_tpl_vars['data']['m_na']; ?>
...
四宅的房子为最佳，<br>最佳坐向：<?php echo $this->_tpl_vars['data']['m_nfw']; ?>
    ...
    <div class="public_bzhh_title J_payPopupShow">
		<span class="left"></span><span class="right"></span><span class="center">第二：<?php echo $this->_tpl_vars['data']['name_a']; ?>
小姐的命格</span><i></i>
	</div>
	<div class="public_lock_content">
		<div class="list1 left">
			<p>生肖：<b><?php echo $this->_tpl_vars['data']['shengxiao2']; ?>
</b> 命宫：<b>为<?php echo $this->_tpl_vars['data']['m_v']; ?>
</b></p>
 ...
 | <?php echo $this->_tpl_vars['data']['shishenb2']; ?>
            ...
            <p>您属于： <?php echo $this->_tpl_vars['data']['m_va']; ?>
...
四宅的房子为最佳，最佳坐向：<?php echo $this->_tpl_vars['data']['m_vfw']; ?>
	...
	<div class="public_lock_content">
		<div class="list2 left">
			<p><?php echo $this->_tpl_vars['data']['haar1']; ?>
</p>
		</div>
	...
	<div class="public_bzhh_title J_payPopupShow">
		<span class="left"></span><span class="right"></span><span class="center">第四：从星座角度分析<?php echo $this->_tpl_vars['data']['name_a']; ?>
与<?php echo $this->_tpl_vars['data']['name']; ?>
的合婚</span><i></i>
	</div>
	<div class="public_lock_content">
		<div class="list2 left">
	...
	<div class="public_lock_content">
		<div class="list2 left">
       <p><?php echo $this->_tpl_vars['data']['haar2']; ?>
</p>
		</div>
	</div>
	<div class="public_bzhh_title J_payPopupShow">
	...
	<div class="public_lock_content">
		<div class="list2 left">
     <p><?php echo $this->_tpl_vars['data']['haar3']; ?>
</p>
		</div>
	</div>
	<div class="public_bzhh_title J_payPopupShow">
	...
	<div class="public_lock_content">
		<div class="list2 left">
		<p><?php echo $this->_tpl_vars['data']['haar4']; ?>
</p>
		</div>
	</div>
	<div class="public_bzhh_title J_payPopupShow">
	...
	<div class="public_lock_content">
		<div class="list2 left">
		<p>命宫为：<?php echo $this->_tpl_vars['data']['m_v']; ?>
</p>
		<p>头胎为：<?php echo $this->_tpl_vars['data']['erzi_a']; ?>
</p>
		</div>
	</div>
	<div class="public_bzhh_title J_payPopupShow">
	...
	<div class="public_lock_content">
		<div class="list2 left">
			<p>二位命卦九宫落在宫位：'<?php echo $this->_tpl_vars['data']['m_n']; ?>
'，此为上等婚 ，(甲方命卦：<?php echo $this->_tpl_vars['data']['m_n']; ?>
...
四命）)</p>
            ...
            <p>(男方属相：<?php echo $this->_tpl_vars['data']['shengxiao1']; ?>
