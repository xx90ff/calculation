<?php /* Smarty version 2.6.25, created on 2021-03-19 14:08:58
         compiled from ffsm/bazijp_find.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8"/>
...
<!--<div style="background-color:#FFFDE5;border:1px solid #E10000;border-radius:8px;color:#000000;font-size:24px;text-align:center;margin:30px 14px;">
  ...
  <div id="guanzhu" style="width:80%;margin:0 auto;margin-top:40px;display:none;">
    <p>步骤一 : 微信扫码关注</p>
    <p>或长按复制微信号添加 :
      <span style="color:#E10000;"><?php echo $this->_tpl_vars['weixinhao']; ?>
</span></p>
    <img src="<?php echo $this->_tpl_vars['weixintp']; ?>
" style="margin:30px 0;width:60%;">
    <p>步骤二 : 在底栏选择相关功能"
