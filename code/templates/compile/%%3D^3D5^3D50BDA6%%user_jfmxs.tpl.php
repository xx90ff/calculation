<?php /* Smarty version 2.6.25, created on 2021-04-06 12:19:21
         compiled from ffsm/user_jfmxs.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'round', 'ffsm/user_jfmxs.tpl', 65, false),array('modifier', 'date_format', 'ffsm/user_jfmxs.tpl', 74, false),)), $this); ?>
<!DOCTYPE html>
<html>
<head>
...
?> 
  <?php if ($this->_tpl_vars['i']['oid'] && $this->_tpl_vars['i']['ext']): ?>
  <div class="public_ddxx">
      <div class="public_k">
           <span class="public_des">[<?php echo $this->_tpl_vars['i']['type']; ?>
]</span><span class="public_pyzt"><?php if ($this->_tpl_vars['i']['class'] == 1): ?><font color="#008000" >消耗</font><?php else: ?>获得<?php endif; ?></span>      </div>
        <div class="public_k">
      <span class="public_pyzt_ddxx">订单号：<?php echo $this->_tpl_vars['i']['oid']; ?>
</span>
    </div>
          <div class="public_k">
      <span class="public_pyzt_ddxx"><?php if ($this->_tpl_vars['i']['class'] == 1): ?>消耗<?php else: ?>获得<?php endif; ?>：<font color="#ff0000" ><?php echo $this->_tpl_vars['i']['ext']; ?>
积分</font></span>
    </div>
      <div class="public_k">
      <span class="public_pyzt_ddxx">时间：<?php echo ((is_array($_tmp=$this->_tpl_vars['i']['time'])) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d %H:%M:%S') : smarty_modifier_date_format($_tmp, '%Y-%m-%d %H:%M:%S')); ?>
</span>
    </div>
