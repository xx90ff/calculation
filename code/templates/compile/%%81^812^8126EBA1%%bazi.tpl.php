<?php /* Smarty version 2.6.25, created on 2021-03-21 10:48:44
         compiled from ffsm/bazi.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8"/>
<title>八字测试八字精批、2021流年运程详解、八字测试服务-<?php echo $this->_tpl_vars['zhanming']; ?>
</title>
<meta name="keywords" content="八字精批,生辰八字,八字排盘" />
<meta name="description" content="<?php echo $this->_tpl_vars['zhanming']; ?>
为您提供八字精批在线测试，给有缘人提供八字排盘,八字精批等专业的八字在线测试服务,我们将会用心服务每一个善信有缘人,祝您及您的家人生活幸福安康。" />
...
<div class="public_banner">
	<img src="/statics/ffsm/bazijingpi/1/images/00.jpg" alt="八字精批"/>
...
<div class="public_bg_color">
	<div class="public_border_tit">
		...
		<div class="public_bt_body">
			<span>大师专业八字命运精批</span>
		</div>
		<div class="public_bt_down">
			<span></span>
		</div>
	</div>
<img style="width:99%; height:auto; margin:0 auto; display:block;" src="/statics/ffsm/bazijingpi/1/images/000.jpg" alt="八字精批"/>
	<div class="form_top_title" id="submit2">
		立即揭开八字奥秘
	</div>
...
<div style="text-align:center;">
	<span style="font-size:16px;">→你的人生秘密藏在怎样的八字组合里？←</span>
</div>
<p>
<br />
</p>
<div style="text-align:center;">
	<strong><span style="font-size:18px;">这些问题是否经常困扰着你？</span></strong>
</div>
<br />
<img style="width:96%; height:auto; margin:0 auto; display:block;" src="/statics/ffsm/bazijingpi/1/images/102.jpg" alt="测试内容对您有什么帮助"/>
<br />
	<div class="public_border_tit">
		<div class="public_bt_top">
			<span></span>
	...
	<div class="know_img">
		<img src="/statics/ffsm/bazijingpi/1/images/0_img_11.jpg" alt="测试内容对您有什么帮助"/>
	</div>
</div>
<div class="public_bg_color">
	<div class="public_border_tit">
	...
	<div class="know_img">
		<img style="width:96%; height:auto; margin:0 auto; display:block;" src="/statics/ffsm/bazijingpi/1/images/0_img_2.jpg" alt="测试后您将知道以下信息"/>
	</div>
</div>
<div class="public_bg_color">
	<div class="public_border_tit">
...
<div class="public_bg_color">
	...
	<div class="user_feedback">
		<div class="uf_top">
			<p><b>98.6%</b>的用户通过测试明确了自己的人生方向</p>
		</div>
		<div class="uf_ul_wrap" id="feedbackScroll">
			<ul class="uf_ul">
				...
				<p>
					我之前对考公有些抗拒，测试后发现自己更适合事业单位，现在已经入职啦。
				</p>
				</li>
				...
				<p>
					我的性格和测试中说的一模一样，自己在事业上老师犹豫不决，还好有老师的建议。谢谢老师！
				</p>
				</li>
				...
				<p>
					原来我是做行政工作的，工作并不顺心。希望能如测试结果所说通过跳槽改善自己的事业运势。
				</p>
				</li>
				<li><strong>任先生 186****1311</strong>
				<p>
					通过该测试得知自己最近3个月的运势不佳，赶紧按照老师建议调整自己的床头方向，佩戴吉祥物等。运势有了很大的改观，生活，工作渐渐有起色。
				</p>
				</li>
...
<div class="public_bg_color as_form">
	<div class="input_text">
        <span class="on">昵称：</span><input type="text" name="username" placeholder="你测试时填写的姓名">
    </div>
    <div class="input_text">
        <span class="on">订单号：</span><input type="text" name="username" placeholder="你测试时填写的姓名">
    </div>
    <div class="input_text">
        <span class="on">评论内容：</span><input type="text" name="username" placeholder="你测试时填写的姓名">
    </div>
...
<hr />
<img style="width:100%; height:auto; margin:0 auto; display:block;" src="/statics/ffsm/bazijingpi/1/images/dwbz.jpg" alt="顿悟八字提前趋吉避凶"/>
</div>
