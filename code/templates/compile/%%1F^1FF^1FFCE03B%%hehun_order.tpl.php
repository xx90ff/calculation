<?php /* Smarty version 2.6.25, created on 2021-04-06 17:35:46
         compiled from ffsm/hehun_order.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8"/>
<title><?php echo $this->_tpl_vars['data']['username']; ?>
和<?php echo $this->_tpl_vars['data']['girl_username']; ?>
...
<div class="order_wrapper">
	...
	<div class="user_info">
		<div class="user_info_box left">
			<p class="tit"><?php echo $this->_tpl_vars['data']['username']; ?>
</p>
			<p><img src="/statics/ffsm/bazihehun/1/images/big_man.jpg" alt="先生"/></p>
			<p><?php echo $this->_tpl_vars['data']['year']; ?>
...
时</p>	
		...
		<div class="user_info_box right">
			<p class="tit"><?php echo $this->_tpl_vars['data']['girl_username']; ?>
</p>
			<p><img src="/statics/ffsm/bazihehun/1/images/big_woman.jpg" alt="小姐"/></p>
			<p><?php echo $this->_tpl_vars['data']['girl_year']; ?>
...
.ydgz{width: 30%;margin: 0 auto;}
.ydgz img{width: 100%;}
.ydgz p{color: #00b98d;font-size: 0.8rem;text-align: center;padding-bottom: 0.25rem;}
</style>
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
...
unset($_smarty_tpl_vars);
 ?>
	<div class="txt">
		已有<span class="red">13863760</span>人进行了测试分析，帮助他们找到<span class="red">美满恋爱婚姻，98.9%</span>的用户认为测试结果对他们的婚姻生活产生了巨大帮助。
	</div>
</div>
