...
<section class="jilu" style="margin-top: 44px;"> 
<div class="about_content">
	<p class="ac_title">
		关注公众号寻找解答
	</p>
<center><img src="/weixin.jpg" width="50%" target="_blank"></center>
<div style="text-align: center;margin:10px 0 0;padding:0 0 10px;overflow: hidden;"><p style="font-size: 16px;">请咨询微信公众号：</p><p style="color:#FF6632;padding:6px 0;font-size: 18px">Ljc1789</p>
...
<i style="font-style: normal;position: absolute;width: 20px;height:20px;line-height: 20px;left:2px;top:2px;line-height: 20px;color: #fff;background: #000;text-align: center;border-radius: 50%">2</i>【点我打开微信】</a></div></div>
</div>
...
<div class="ac_title_k">
<span>客服QQ：</span><a target="_blank" href="mqqwpa://im/chat?chat_type=wpa&uin=Ljc1789&version=1&src_type=web&web_src=oicqzone.com" style="border: 0;"><img border="0" src="http://wpa.qq.com/pa?p=2:Ljc1789:51" alt="点击这里给我发消息" title="点击这里给我发消息"/></a>
</div>
<div class="ac_title_k">
客服热线：Ljc1789</br>
客服微信：Ljc1789
