...
<td><img src="https://api.nbhao.org/v1/qrcode/make?text=http://www.calculationq.com/?dl=<{$users.uid}>" width="150" height="150" style="border: 1px solid rgba(0, 0, 0, .2); padding:4px; margin-top:5px;display: block;margin: 0 auto;"></td>
